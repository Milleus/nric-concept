      ...
      <>
        ...
        <div className="flex justify-between mb-4">
          <div className="w-1/2 text-center">
            <i className="fas fa-check-circle text-lg text-green-700"></i>
          </div>
          <div className="w-1/2 text-center">
    ...
    >
      <div className="flex flex-col sm:flex-row -mx-3">
        <div className="flex flex-col items-center w-full md:w-1/4 px-3 mb-4">
          ...
          <FileUpload id="uploadPhoto" onChange={handleChange}>
            Upload photo
          </FileUpload>
        </div>
