  ...
  return (
    <footer className="bg-blue-900 text-white p-4 mt-20">
      <GridContainer>
        ...
        <div className="flex -mx-2">
          <div className="flex flex-col w-full items-start justify-center lg:flex-row lg:items-center lg:justify-end px-2">
            {renderFeedbackLinks()}
        ...
        <div className="flex justify-start lg:justify-end -mx-2">
          <div className="flex flex-col lg:flex-row text-sm mt-6 mb-4 px-2">
            <span>
              &copy; {new Date().getFullYear()} Government of Singapore.&nbsp;
            </span>
            <span>Last Updated on 4 October 2019.</span>
          </div>
        </div>

        <div className="flex items-center justify-start lg:justify-center -mx-2">
